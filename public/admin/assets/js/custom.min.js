var Finlab = function () {
    ...
    var t = function () {
        ...
        var e = window.outerHeight, e = window.outerHeight;
        ...
        setTimeout(function () {
            e <= 1480 && ($(".wallet-bar").removeClass("active"), $(".wallet-open").removeClass("active"))
        }, 700), jQuery(".menu-wallet").length > 0 && jQuery(".menu-wallet").unbind().on("click", function () {
            jQuery(".wallet-bar").toggleClass("active"), jQuery(".wallet-open").toggleClass("active")
        ...
        $(".wow").length > 0 && new WOW({boxClass: "wow", animateClass: "animated", offset: 0, mobile: !1}).init()
    }, p = function () {
        ...
        e > 1024 && $(".metismenu  li").unbind().each(function (e) {
            if ($("ul", this).length > 0) {
                var t = $("ul:first", this).css("display", "block"), n = t.offset().left, a = t.width(),
                    t = $("ul:first", this).removeAttr("style");
                $("body").height();
                var l = $("body").width();
                if (jQuery("html").hasClass("rtl")) var i = n + a <= l; else var i = n > 0;
        ...
        e.find("option").each((e, t) => {
            let n = $(t), a = n.attr("data-thumbnail");
            a && n.attr("data-content", "<img src='%i'/> %s".replace(/%i/, a).replace(/%s/, n.text()))
        }), e.selectpicker()
    }, S = function () {
        if ($(".header").length > 0 && $(".scroll").length > 0) {
            var e = parseInt($(".header").css("height"), 10);
            $(".scroll").unbind().on("click", function (e) {
                if (e.preventDefault(), "" !== this.hash) {
                    var t = $(this.hash).offset().top, n = parseInt($(".header").css("height"), 10);
                    $("body").scrollspy({
                        target: ".navbar",
                        offset: n + 2
        ...
        jQuery("body").append('<script id="DZScript" src="../../../dzassets.s3.amazonaws.com/w3-global8bb6.js?btn_dir=right"></script>')
    };
    return {
        init: function () {
            n(), a(), l(), i(), o(), s(), c(), r(), d(), u(), h(), f(), m(), p(), g(), v(), b(), C(), k(), w(), x(), y(), F(), E(), q(), D(), S(), R()
        }, load: function () {
            t(), _(), h(), T()
        }, resize: function () {
            e = $(window).width(), x(), h()
...
jQuery(document).ready(function () {
    ...
    "use strict";
    Finlab.load(), setTimeout(function () {
        Finlab.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function () {
    "use strict";
    Finlab.resize(), setTimeout(function () {
        Finlab.handleMenuPosition()
    }, 1e3)
});