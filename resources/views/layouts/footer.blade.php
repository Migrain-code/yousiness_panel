                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-footer__widget footer-widget-3 footer-widget-5 footer-col-3-1">
                            <div class="tp-footer__logo mb-25">
                                <a href="/">
                                    <img src="{{asset(config('settings.bussiness_main_black_logo'))}}" alt="">
                                </a>
                            </div>
                            <div class="tp-footer__contact-info">
                                <p>
                                    {{config('settings.bussiness_footer_about')}}
                                </p>
                                <ul>
                                    <li>
                                       <span>
                                        ...
                                        <a class="first-child" href="tel:{{config('settings.site_phone')}}">{{config('settings.site_phone')}}</a>
                                    </li>
                                    <li>
                                       <span>
