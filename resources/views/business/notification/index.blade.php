                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                               @forelse(auth('business')->user()->notifications as $notification)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('business.businessNotification.show', $notification->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-eye"></i></a>
                                                <a href="javascript:void(0)" onclick="onDelete('{{route('business.businessNotification.destroy', $notification->id)}}', '{{$loop->index}}')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                               @empty
