...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                               @forelse(auth('business')->user()->campaigns as $campaign)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('business.campaign.edit', $campaign->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-edit"></i></a>
                                                <a href="javascript:void(0)" onclick="onDelete('{{route('business.campaign.destroy', $campaign->id)}}', '{{$loop->index}}')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                               @empty
    ...
    <div class="modal fade bd-example-modal-lg" id="campaign-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('business.campaign.store')}}">
                    @csrf
