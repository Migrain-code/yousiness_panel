                            ...
                            <tbody>
                               @forelse(auth('business')->user()->products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('business.product.edit', $product->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                <a href="javascript:void(0)" onclick="onDelete('{{route('business.product.destroy', $product->id)}}', '{{$loop->index}}')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                               @empty
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('business.product.store')}}">
                    @csrf
...
<script>
    ...
    <script>
        ...
        $(function() {
            $('#priceInput').mask("#.##0", {reverse: true});
        });
    </script>
