                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end of-visible">
                            ...
                            <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                <ul class="timeline">
                                    @forelse(auth('business')->user()->notificationsMenu as $notification)
                                        <li>
                                            <a href="{{route('business.businessNotification.show', $notification->id)}}">
                                            <div class="timeline-panel">
                                                <div class="media me-2">
                                                    <i class="fa fa-bell"></i>
                                                </div>
                                                <div class="media-body">
                                                        <h6 class="mb-1">{{ucfirst($notification->title)}}</h6>
                                    ...
                                    @empty
                                        <div class="alert alert-primary">Keine Nachricht gefunden</div>
                                    @endforelse
                                </ul>
                            </div>
                            <a class="all-notification" href="{{route('business.businessNotification.index')}}">Alle Nachrichten <i class="ti-arrow-end"></i></a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <div class="dropdown header-profile2">
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    <div class="d-flex align-items-center sidebar-info">
                                        <div>
                                            ...
                                            <span class="d-block text-end">{{auth('business')->user()->owner ?? "Keine Installation"}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                <a href="{{route('business.profile.show')}}" class="dropdown-item ai-icon ">
                                ...
                                <a href="{{route('business.support.index')}}" class="dropdown-item ai-icon ">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <a href="{{route('business.businessNotification.index')}}" class="dropdown-item ai-icon ">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"/>
