        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#support-modal"><i class="fa-solid fa-plus-circle me-2"></i>Anfrage erstellen</button>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                               @forelse(auth('business')->user()->supports as $support)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('business.support.show', $support->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-eye"></i></a>
