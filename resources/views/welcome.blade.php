...
@section('content')
    <main class="fix">
                        ...
                        <div class="postbox__comment-form" style="background-color: white;padding: 20px;border-radius: 20px">
                            ...
                            <form action="{{route('getInfo')}}" class="box" method="post">
                                ...
                                <div class="row p-3 text-center">
                                    <h1 style="color: #600ee4;">Sizi arayalım</h1>
                                    <p>Sistem hakkında bilgi almak için aşağıdaki formu doldurun sizi arayalım.</p>
                                </div>
                                <div class="row gx-20">
                                    <div class="col-12">
                                        <div class="postbox__comment-input mb-30">
                                            <input type="text" name="fullname" class="inputText" required>
                                            <span class="floating-label">İşletme sahibi</span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="postbox__comment-input mb-30">
                                            <input type="text" name="business_name" class="inputText" required>
                                            <span class="floating-label">İşletme Adı</span>
                                        </div>
                                    </div>
                                    <div class="col-12">
        ...
        <div class="tp-testimonial-area pt-130 pb-130 mb-55 fix" data-background="/business/assets/img/testimonial/testi-bg-5-1.jpg">
            <div class="container">
