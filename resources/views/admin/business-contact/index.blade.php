                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display" style="min-width: 845px; width: 100%">
                            ...
                            <tbody>
                               @forelse($businessContacts as $contact)
                                    <tr>
                                        ...
                                        <td>
                                            @if($contact->status == 0)
                                                <span class="badge light badge-danger"><strong>Aranamadı</strong></span>
                                            @else
                                                <span class="badge light badge-success">Arandı</span>
                                            @endif
                                        </td>
                                        <td>{{$contact->created_at->format('d.m.Y')}}</td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('admin.businessContact.show', $contact->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-eye"></i></a>
                                                <a href="javascript:void(0)" onclick="onDelete('{{route('admin.businessContact.destroy', $contact->id)}}', '{{$loop->index}}')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                               @empty
