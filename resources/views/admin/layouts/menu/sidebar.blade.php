        ...
        <ul class="metismenu" id="menu">
            ...
            <li @if(request()->routeIs('admin.blog.*')) class="mm-active"  @endif >
                <a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <span class="nav-text">Site İşlemleri
                    </span>
                </a>
                <ul  @if(request()->routeIs('admin.blog.*')) class="mm-collapse mm-show" aria-expanded="true" @else aria-expanded="false" @endif>
                    ...
                    <li>
                        <a href="{{route('admin.serviceSubCategory.index')}}">Hakkımızda İşlemleri</a>
                    </li>
                    <li>
                        <a href="{{route('admin.socialMedia.index')}}">Sosyal Medya İşlemleri</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('admin.forBusiness.index')}}">İşletmeler İçin</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <a class="has-arrow " href="{{route('admin.settings')}}">
