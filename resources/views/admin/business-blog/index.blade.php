                ...
                <div class="modal fade" id="exampleModalCenter">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content" style="width: 800px">
                            ...
                            <form method="post" style="width: 800px" action="{{route('admin.businessBlog.store')}}" enctype="multipart/form-data">
                    ...
                    <table id="example" class="display" style="min-width: 845px;width: 100%">
                        ...
                        @forelse($blogs as $blog)
                            <tr class="rowDelete">
                                ...
                                <td>
                                    <a class="btn btn-primary" style="margin-right: 0px;" href="{{route('admin.businessBlog.edit', $blog->id)}}"><i class="fa fa-edit"></i></a>
                                    <button type="button" class="btn btn-warning" onclick="statusAction('{{$blog->id}}')"><i class="fa fa-check-circle"></i></button>
                                    <button type="button" class="btn btn-danger" onclick="deleteAction('{{route('admin.businessBlog.destroy', $blog->id)}}', '{{$loop->index}}')"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        @empty
                            <tr>
...
@section('scripts')
    ...
    <script>
        function statusAction(id){
            $.ajax({
                url:'{{route('admin.businessBlog.updateStatus')}}',
                type: "POST",
                data:{
                    id:id,
                    _token:'{{csrf_token()}}'
