                ...
                <div class="modal fade" id="exampleModalCenter">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{route('admin.businnessType.store')}}">
                            ...
                            @forelse($types as $type)
                                <tr class="rowDelete">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger" onclick="deleteAction('{{route('admin.businnessType.destroy', $type->id)}}', '{{$loop->index}}')"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
