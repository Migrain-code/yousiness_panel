                ...
                <div class="modal fade" id="exampleModalCenter">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{route('admin.serviceCategory.store')}}">
                    ...
                    <table id="example" class="display" style="min-width: 845px">
                        ...
                        <tbody>
                            @forelse($categories as $categorie)
                                <tr class="rowDelete">
                                    <td>{{$categorie->type->name}}</td>
                                    <td>
                                        {{$categorie->name}}
                                    </td>
                                    <td>
                                        <a class="btn btn-primary" href="{{route('admin.serviceCategory.edit', $categorie->id)}}"><i class="fa fa-edit"></i></a>
                                        <button type="button" class="btn btn-danger" onclick="deleteAction('{{route('admin.serviceCategory.destroy', $categorie->id)}}', '{{$loop->index}}')"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
