...
Route::group(['prefix' => 'business', 'as' => 'business.'], function () {
    ...
    Route::middleware(['auth:business', 'setup'])->group(function () {
        ...
        Route::get('appointment/customer/list', [\App\Http\Controllers\Business\CustomerController::class, 'listView'])->name('customer.list');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::post('business/notification/send', [\App\Http\Controllers\Admin\BusinessController::class, 'sendNotify'])->name('business.sendNotify');
